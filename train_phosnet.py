...
# Function to build and return SPP-PHOSNet model 
...
# Generating dictionaries of words mapped to PHOS vectors
...
early_stop = tf.keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=1e-7, patience=10, verbose=2,mode='auto', baseline=None, restore_best_weights=False)
